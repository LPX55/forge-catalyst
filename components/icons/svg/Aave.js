...
const SvgAave = (props) => (
  ...
  >
    <defs>
      <path id="AAVE_svg__a" d="M0 0h800v800H0z" />
    </defs>
    <clipPath id="AAVE_svg__b">
      <use
        xlinkHref="#AAVE_svg__a"
        style={{
          overflow: "visible",
        }}
      />
