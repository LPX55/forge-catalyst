...
const SvgBnb = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2500.01 2500" {...props}>
    <defs>
      <style>{".BNB_svg__cls-1{fill:#f3ba2f}"}</style>
    </defs>
    <g id="BNB_svg__Layer_2" data-name="Layer 2">
      <g id="BNB_svg__Layer_1-2" data-name="Layer 1">
        <path
